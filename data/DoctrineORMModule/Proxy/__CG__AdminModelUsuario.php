 ...
 */
class Usuario extends \Admin\Model\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'email', 'senha', 'data_nascimento', 'perfil');
        }
    ...
    public function setDataNascimento($data_nascimento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataNascimento', array($data_nascimento));
